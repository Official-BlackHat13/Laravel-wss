         ...
         <div class="row">
            <div class="col-lg-12">
               <div class="card">
                  ...
                  <form method="post" action="{{route('update-product')}}"  accept-charset="utf-8" enctype="multipart/form-data">
                     @csrf
                     <div class="card-body">
                        <div class="row">
                           <div class="col-md-6">
                        ...
                        <div class="row">
                           <div class="col-md-12">
                              ...
                              <textarea type="text" class="form-control @error('product_description') is-invalid @enderror" name="product_description">{{$edituser->Attribute1}}</textarea>
                           </div>
                        </div><br>
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              ...
                              <select class="form-control" name="shape">
                                ...
                                @foreach($data1 as $dt)
                                    <option value="{{$dt}}" <?php if($edituser->Attribute2 == $dt){echo 'selected';} ?>>{{$dt}}</option>
                                @endforeach
                              </select>    
                           </div>
                           <div class="col-md-6">
                              ...
                              <select class="form-control" name="type">
                                <option value="">Select Any One</option>
                                @foreach($data1 as $dt)
                                    <option value="{{$dt}}" <?php if($edituser->Attribute3 == $dt){echo 'selected';} ?>>{{$dt}}</option>
                                @endforeach
                              </select> 
                           </div>
                        </div>
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              ...
                              <select class="form-control" name="frame_material">
                                <option value="">Select Any One</option>
                                @foreach($data1 as $dt)
                                    <option value="{{$dt}}" <?php if($edituser->Attribute4 == $dt){echo 'selected';} ?>>{{$dt}}</option>
                                @endforeach
                              </select> 
                           </div>
                           <div class="col-md-6">
                              ...
                              <select class="form-control" name="frame_fit">
                                <option value="">Select Any One</option>
                                @foreach($data1 as $dt)
                                    <option value="{{$dt}}" <?php if($edituser->Attribute5 == $dt){echo 'selected';} ?>>{{$dt}}</option>
                                @endforeach
                              </select>  
                           </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                              <label>Made In:</label>
                               <input type="text" class="form-control" name="made_in" value=""> 
                           </div>
                        </div>
                        <br>
                        <div class="row">
