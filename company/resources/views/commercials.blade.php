                        ...
                        <div class="row">
                                ...
                                <form action="{!!route('payment')!!}" method="POST" >
                                    <div class="col-md-4">
                                       ...
                                       <!--<button class="btn btn-primary" style="margin-top:35px;">Pay Now</button>-->
                                    ...
                                    <input type="hidden" class="form-control"  name="amount" readonly value="{{$total}}">
                                    <input type="hidden" class="form-control" name="company_id"   value="<?php  echo $a = (!empty(auth()->user()->id))? auth()->user()->id: 0;?>">
                                    <input type="hidden" class="form-control" name="order_id"  value="<?php echo uniqid();?>">
