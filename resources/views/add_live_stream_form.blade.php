   ...
   <div class="section__content section__content--p30">
      <div class="container-fluid">
         ...
         <div class="row">
            <div class="col-lg-12">
               <div class="card">
                  <div class="card-header">Add Live Stream Form</div>
                  <form method="post" action="{{route('storelive')}}"  enctype="multipart/form-data">
                     @csrf
                     <div class="card-body">
                        <div class="row">
                             <div class="col-md-8">
                                 <label>Assign Phone</label>
                                 <input type="number" placeholder="Assign Phone No To Stream" class="form-control" name="assign_phone">
                             </div>
                        </div><br>
                        ...
                        <div class="row">
                             <div class="col-md-8">
                                 ...
                                 <input type="email" placeholder="Assign Email To Stream" class="form-control" name="assign_email">
                             </div>
                        </div><br>
                        ...
                        <div class="row">
                             <div class="col-md-8">
                                 ...
                                 <input type="text" placeholder="Page URL Embed Code" class="form-control" name="code">
                             </div>
                        </div><br>
                        ...
                        <div class="row">
                             <div class="col-md-8">
                                 ...
                                 <input type="text" placeholder="Enter Promo Name" class="form-control" name="promo_name">
                             </div>
                        </div><br>
                        ...
                        <div class="row">
                             <div class="col-md-8">
                                 <label>Message</label>
                                 <textarea class="form-control" name="message" placeholder="Introduction Or Welcome Message"></textarea>
                             </div>
                        </div><br>
