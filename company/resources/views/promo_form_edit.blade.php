   ...
   <div class="section__content section__content--p30">
      <div class="container-fluid">
         <div class="row">
            <div class="col-lg-12">
               <div class="card">
                  <div class="card-header">Edit Promo Form</div>
                  <form method="post" action="{{route('update-promo')}}"  enctype="multipart/form-data">
                     @csrf
                     <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <div class="row">
                             <div class="col-md-6">
                                 ...
                                 <input type="text" placeholder="Enter Promo Name" class="form-control" name="promo_name" value="{{$edituser->promo_name}}">
                             </div>
                             <div class="col-md-6">
                                 <label>Headline</label>
                                 <input type="text" placeholder="Enter Headline" class="form-control" name="headline" value="{{$edituser->headline}}">
                             </div>
                        </div><br>
                        <div class="row">
                             <div class="col-md-6">
