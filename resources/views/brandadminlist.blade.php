...
<div class="main-content">
    <div class="section__content section__content--p30">
        <div class="container-fluid">
            ...
            @endif
            <div class="row">
                <a href="{{route('add-brand-admin')}}"><button class="btn btn-primary">Add Brand Admin</button></a>&nbsp;
                <button style="margin-bottom:15px;" class="btn btn-danger btn-xs delete-all" id="btnPrintbrand">Delete Selected</button>&nbsp;
    					...
    					<div class="excelFields" style="margin-top:20px;">
    						...
    						<div class="form-group">
      							<label class="form-checkbox">
    								...
    								<i class="form-icon"></i> Pincode Managed
      							</label>
    						</div>
    						<div class="form-group">
      							<label class="form-checkbox">
