...
class LiveStreamController extends Controller
{
    ...
    public function index1(){
        $users1 = DB::table('store_stream')->select('store_stream.*')->orderBy('store_stream.id','desc')->get();
    ...
    public function index(){
        $users1 = DB::table('promo')->select('promo.*')->orderBy('promo.id','desc')->get();
    ...
    public function staff(){
        $users1 = DB::table('staff_live_update')->select('staff_live_update.*')->orderBy('staff_live_update.id','desc')->get();
