...
class CompanyController extends Controller
{
    ...
    public function create()
    {
        ...
        $store_city= DB::table('banner_cities')->select('banner_cities.*')->get();
        ...
        return view('add_company_form1',['country'=>$country,'pin'=>$pin,'supcat'=>$supcat,'cat'=>$cat,'subcat'=>$subcat,'company'=>$company,'brand'=>$brand,'store_city'=>$store_city]);
    }
    public function store(Request $request)
    {
        ...
        $store_city = (!empty($request->input('store_city'))) ? $request->input('store_city') : '';
        ...
        $insert = DB::table('company_admin')->insertGetId([
        ...
        $insert1= DB::table('account_commercials')->insert([
            'company_id'=>$short_name,
            'city'=>$store_city,
            'quick_shop'=>$quick,
            'online_shop'=>$online,
        ...
        $result2 = substr($contact_name, 0, 2);
        $result3 = substr($contact_mobile,-4);
        ...
        $radius = (!empty($request->input('radius'))) ? $request->input('radius') : '';
        $served_pincode = $request->input('served_pincode');
        
            
        foreach ($outlet_pincode as $key => $value){
            $outlet_location1= (!empty($outlet_location[$key]))? $outlet_location[$key]: '';
            $outlet_pincode1= (!empty($outlet_pincode[$key]))? $outlet_pincode[$key]: '';
            $radius1= (!empty($radius[$key]))? $radius[$key]: '';
            $served_pincode1= implode(',',$served_pincode);
            ...
            $insert = DB::table('outlets')->insert([
                ...
                'state' => $state,
                'city'=>$city,
                'outlet_location'=>$outlet_location1,
                'outlet_pincode'=>$value,
                'served_pincode' => $served_pincode1,
                'radius'=>$radius1
                ]);
        }
