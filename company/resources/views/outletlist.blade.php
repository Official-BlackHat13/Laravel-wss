    ...
    <div class="section__content section__content--p30">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <a href="#" data-toggle="modal" data-target="#exampleModal"><button class="btn btn-info" >Import Outlet</button></a>&nbsp;
                <a href="{{route('Liaison')}}"><button class="btn btn-success">Assign Liaison</button></a>&nbsp;
            </div>   
            <div class="row">
                <div class="col-md-12">
