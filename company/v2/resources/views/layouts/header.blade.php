...
<body class="animsition">
    <div class="">
        ...
        <aside class="menu-sidebar2">
            ...
            <div class="menu-sidebar2__content js-scrollbar1  js-left-sidebar d-none d-lg-block mainsidebar">
                <div class="account2">
                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class=" has-sub">
                            <a  href="{{route('view-account')}}">
                                <i class="fas fa-tasks"></i>View My Account
                            </a>
                        </li>
                        <li class=" has-sub">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list" >
                                <li>
                                    <a  href="{{route('brand-admin')}}">
                                        <i class="fas fa-tasks"></i>Brand Admin - Commercials
                                    </a>
                                </li>
                                <li>
                                    <a  href="{{route('brand-admin')}}">
                                        <i class="fas fa-tasks"></i>Brand Admin - Inventory
                                    </a>
                                </li>
                                <li>
                                    <a  href="{{route('brand-admin')}}">
                                        <i class="fas fa-tasks"></i>Brand Admin -Staff Updates
                                    </a>
                                </li>
                                <li>
                                    <a  href="{{route('brand-admin')}}">
                                        <i class="fas fa-tasks"></i>Brand Admin - Coupon Vouchers
                                    </a>
                                </li>
                                <li>
                                    <a  href="{{route('brand-admin')}}">
                                        <i class="fas fa-tasks"></i>Brand Admin - Stores
                                    </a>
                                </li>
                                <li>
                                    <a  href="{{route('brand-admin')}}">
                                        <i class="fas fa-tasks"></i>Brand Admin - Live Stream 
                                    </a>
                                </li>
                                <li>
                                    <a  href="{{route('brand-admin')}}">
                                        <i class="fas fa-tasks"></i>Brand Admin - Training & Awards 
                                    </a>
                                </li>
                                
                                <li>
                                    <a  href="{{route('store-admin')}}">
                                        <i class="fas fa-tasks"></i>Store Admin - Inventory & Order Processing
                                    </a>
                                </li>
                                <li>
                                    <a  href="{{route('store-admin')}}">
                                        <i class="fas fa-tasks"></i>Store Admin - Sales Expert
                                    </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="has-sub">
                            <a class="js-arrow" href="#">
                                <i class="fas fa-bank" ></i>Manage Store Inventory & Order Processing
                                <span class="arrow">
                                    <i class="fas fa-angle-down"></i>
                                </span>
                            </a>
                        ...
                        <li class=" has-sub">
                            <a  href="#">
                                <i class="fas fa-tasks"></i>Support
                            </a>
                        </li>
                        
                        <li class=" has-sub">
                            <a  href="#">
                                <i class="fas fa-tasks"></i>Tutorials
                            </a>
                        </li>
                    </ul>
                </nav>
