...
class OutletController extends Controller
{
    public function index(){
        $users1 = DB::table('outlets')->select('outlets.*')->orderBy('outlets.id','desc')->get();
    ...
    public function lision(){
        $users1 = DB::table('outlets')->select('outlets.*')->where('status','=',1)->get();
        $users2 = DB::table('store_admin')->select('store_admin.*')->where('status','=',1)->get();
