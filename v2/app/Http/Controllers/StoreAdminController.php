...
class StoreAdminController extends Controller
{
    public function index(){
        $users1 = DB::table('store_admin')->select('store_admin.*')->orderBy('store_admin.id','desc')->get();
    ...
    public function create()
    {
        ...
        return view('add_store_admin_form',['country'=>$country,'company'=>$company,'brand'=>$brand]);
    }
    ...
    public function edit($id)
    {
        ...
        $company = DB::table('company_admin')->select('company_admin.company_id')->where('status','=',1)->get();
        $brand = DB::table('brand_admin')->select('brand_admin.brand_admin_id')->where('status','=',1)->get();
        return view('store_admin_form_edit',['edituser'=>$edituser,'country'=>$country,'company'=>$company,'brand'=>$brand]);
    }
