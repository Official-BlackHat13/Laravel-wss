...
<div class="main-content">
    <div class="section__content section__content--p30">
        <div class="container-fluid">
            ...
            @endif
            <div class="row">
                <a href="{{route('add-sub-category')}}"><button class="btn btn-primary">Add Sub Category</button></a>&nbsp;
                <button style="margin-bottom:15px;" class="btn btn-danger btn-xs delete-all" id="btnPrintsubcat">Delete Selected</button>
            </div>
            <div class="row">
                <div class="col-md-12">
