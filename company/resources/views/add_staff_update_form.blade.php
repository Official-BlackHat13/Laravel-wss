   ...
   <div class="section__content section__content--p30">
      <div class="container-fluid">
         <div class="row">
            <div class="col-lg-12">
               <div class="card">
                  <div class="card-header">Add Live Update Form</div>
                     ...
                     <div class="card-body">
                        ...
                        <div class="row">
                             <div class="col-md-6">
                                 ...
                                 <input type="text" placeholder="Enter Video Name" class="form-control @error('video_name') is-invalid @enderror" name="video_name" value="<?php echo $startdate = (!empty(old('video_name')))? old('video_name') : ' ' ?>">
                                 @error('video_name')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                             ...
                             <div class="col-md-6">
                                 <label>Purpose</label>
                                 <input type="text" placeholder="Enter Purpose" class="form-control @error('purpose') is-invalid @enderror" name="purpose" value="<?php echo $startdate = (!empty(old('purpose')))? old('purpose') : ' ' ?>">
                                 @error('purpose')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="row">
                             <div class="col-md-6">
                                 ...
                                 <input type="text"  class="form-control @error('url') is-invalid @enderror" name="url" value="<?php echo $startdate = (!empty(old('url')))? old('url') : ' ' ?>">
                                 @error('url')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
