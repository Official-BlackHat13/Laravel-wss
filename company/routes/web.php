...
Route::post('/get-specification-by-subcategory', 'DropdownController@getspecification')->name('get-specification-by-subcategory');


Route::get('/change-password', 'HomeController@change_password1')->name('change-password');
Route::post('/changepassword', 'HomeController@change_password')->name('changepassword');
...
Route::get('/orderdetails', 'OrderController@index')->name('orderdetails');
Route::get('/updateorderstatus', 'OrderController@UpdateOrderStatus')->name('updateorderstatus');
Route::get('/delete-order/{id}', 'OrderController@deleteorder')->name('delete-order');
Route::post('/multiple-order-delete', 'OrderController@deleteMultiple')->name('multiple-order-delete');
