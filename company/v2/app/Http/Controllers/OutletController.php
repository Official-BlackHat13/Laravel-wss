...
class OutletController extends Controller
{
    public function index(){
        ...
        $users1 = DB::table('outlets')->select('outlets.*')->where("company_id", "like","%".$company_id."%")->orderBy('outlets.id','desc')->get();
    ...
    public function create()
    {
        ...
        return view('add_outlet_form',['country'=>$country,'brand'=>$brand,'pin'=>$pin]);
    }
    ...
    public function edit($id)
    {
        ...
        return view('outlet_form_edit',['country'=>$country,'brand'=>$brand,'edituser'=>$edituser,'pin'=>$pin,'dis_explodes'=>$dis_explode]);
    }
    ...
    public function lision(){
        ...
        $users1 = DB::table('outlets')->select('outlets.*')->where("company_id", "like","%".$company_id."%")->where('status','=',1)->get();
        $users2 = DB::table('store_admin')->select('store_admin.*')->where("company_admin_id", "like","%".$company_id."%")->where('status','=',1)->get();
