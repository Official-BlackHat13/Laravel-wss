...
Route::post('fetch-company-list','apiservices\AppservicesController@fetch_company_list');
Route::post('company-filters','apiservices\AppservicesController@company_filters');
Route::post('company-filters-old','apiservices\AppservicesController@company_filters_old');
Route::post('company-home-page','apiservices\AppservicesController@company_home_page');
Route::post('fetch-product-list','apiservices\AppservicesController@fetch_product_list');
Route::post('fetch-product-list-new','apiservices\AppservicesController@fetch_product_list_new');
...
Route::post('specification','apiservices\AppservicesController@specification');
...
Route::post('checkout-new','apiservices\AppservicesController@checkout_new');
Route::post('checkout-final','apiservices\AppservicesController@checkout_final');
Route::post('checkout-final-new','apiservices\AppservicesController@checkout_final_new');
Route::post('order','apiservices\AppservicesController@order_generation');
Route::post('order-new','apiservices\AppservicesController@order_generation_new');
Route::post('order-history','apiservices\AppservicesController@get_order_info');
Route::post('email-otp','apiservices\AppservicesController@verify_email_otp_send');
Route::post('email-otp-check','apiservices\AppservicesController@verify_email_check_otp');
Route::post('mobile-otp','apiservices\AppservicesController@send_mobile_otp');
Route::post('verify-mobile-otp','apiservices\AppservicesController@verify_mobile_otp_send');
Route::post('mobile-otp-check','apiservices\AppservicesController@verify_mobile_check_otp');
Route::post('shop-type','apiservices\AppservicesController@shop_type');
Route::post('live-stream-calls','apiservices\AppservicesController@live_stream_list');
Route::post('live-shop-calls','apiservices\AppservicesController@live_shop_list');
Route::post('updates','apiservices\AppservicesController@updates');
Route::post('cancel-order','apiservices\AppservicesController@cancel_order');
Route::post('check-pincode-delivery-option','apiservices\AppservicesController@check_pincode_delivery_option');
Route::post('update-fcm-user','apiservices\AppservicesController@update_fcm_user');
Route::post('update-store-admin-status','apiservices\AppservicesController@store_admin_status_block');
...
Route::post('store-update','apiservices\StoreServicesController@store_update');
Route::post('store-live-shop','apiservices\StoreServicesController@store_live_shop');
Route::post('store-live-stream','apiservices\StoreServicesController@store_live_stream');
Route::post('points','apiservices\StoreServicesController@points');
Route::post('store-search','apiservices\StoreServicesController@store_search');
Route::post('send-messages','apiservices\StoreServicesController@send_messages');
Route::post('get-messages','apiservices\StoreServicesController@get_messages');
Route::post('get-messages-new','apiservices\StoreServicesController@get_messages_new');
Route::post('initiate-call','apiservices\StoreServicesController@initiate_call');
Route::post('update-fcm-store','apiservices\StoreServicesController@update_fcm_store');
Route::post('update-call-status','apiservices\StoreServicesController@update_call_status');