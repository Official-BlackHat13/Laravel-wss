...
@yield('content')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.js-example-basic-multiple9').select2();
            $('.js-example-basic-multiple10').select2();
            $('.js-example-basic-multiple11').select2();
            $('.js-example-basic-multiple12').select2();
            $('.js-example-basic-multiple13').select2();
            $('.js-example-basic-multiple14').select2();
            $('.js-example-basic-multiple15').select2();
        });
